        ...
        for i, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['val_freq'] == 0:
                ...
                for val_data in val_loader:
                    ...
                    model.feed_data(val_data, need_MR=False, need_MAT=False)
                    model.test()
                    ...
                    denoise_img = util.tensor2img(visuals['LR']-visuals['MR'])
                    ...
                    save_img_path = os.path.join(img_dir, '{:s}_denoise_{:d}.png'.format(img_name, current_step))
                    util.save_img(denoise_img, save_img_path)
