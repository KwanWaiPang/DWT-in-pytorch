...
def parse(opt_path, is_train=True):
    ...
    elif opt['adabn'] is not None:
        adabn_root = os.path.join(opt['path']['root'], 'adabn', opt['name'])
        opt['path']['adabn_root'] = adabn_root
        opt['path']['log'] = adabn_root
        opt['path']['models'] = os.path.join(adabn_root, 'models')
    else:  # test
...
def save(opt):
    if opt['is_train']:
        dump_dir = opt['path']['experiments_root']
    elif opt['adabn'] is not None:
        dump_dir = opt['path']['adabn_root']
    else:
        dump_dir = opt['path']['results_root']
